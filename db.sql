...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2017 at 11:19 AM
...
(10, 'SBI Noida', '4', 'assets/images/logos/thumb.jpg', 'sbinoida@gmail.com', '7903292834', 'onlinesbi.ac.in', 'Noida', 4, 1000, 1);
...
(1, 'Frontend Developer', 'Facebook', '0-2yr', '$120k', 'Palo Alto', 'HTML, CSS, JavaScript', 'Will have to make the front-end systems', '2017-06-24 05:17:30.30957', 1, 'frontend, html, css, javascript, facebook, developer, palo alto, it'),
(2, 'Systems Engineer', 'Dell', '2-3y', '$80k', 'Mountain View, Cali', 'Node.js, Python', 'Make the logic that drives these huge websites', '2017-06-27 07:38:14.51263', 1, 'systems engineer dell node python it'),
(3, 'Manufacturing Officer', 'Tata Steel', '2-3y', '$100k', 'Jamshedpur', 'Catia, ANSYS', 'Guide the workers and maintain a large project', '2017-06-22 08:16:27.48124', 2, 'tata steel jamshedpur manufacturing catia ansys engineering'),
(4, 'Full-Stack Developer', 'Facebook', '2-4yr', '$140k', 'Silicon Valley, CA', 'MVC, Angular, Node.js, Sockets.io, Django', 'You will be responsible for managing the application, from starting to the deployment, testing of new features, regular updates on teams working under', '2017-06-25 06:32:12.38767', 1, 'full stack mvc angular node nodejs, node.js js javascript facebook sockets django developer it silicon valley it '),
(15, 'Android Developer', 'Dell', '1-3y', '$80K', 'Bangalore', 'Kotlin, Java, Android Studio', 'Makes android apps', '2017-07-25 07:29:17.00000', 1, 'android, java, kotlin, studio it');
...
(6, 'Systems Engineer', 'Dell', 26092, '2017-07-25 09:13:15', 'uploads/shubham_Systems Engineer_Resume_2.pdf', 'Shubham Raj', 'shubham@gmail.com', 'shubham', 'SUCCESS'),
...
(8, 'Android Developer', 'Dell', 3041, '2017-07-25 09:53:10', 'uploads/stym06_Android Developer_Notice.pdf', 'Satyam Raj', 'satyammast@gmail.com', 'stym06', 'PENDING');
...
(1, 'stym06', 'satyammast@gmail.com', '3814d460c26c2dbab2d80294d2cc9882', 'uploads/user/stym06_12657395_1725087474403999_4600278323853228972_o.jpg', 'Satyam Raj', '8235639917', 'Ranchi', 'HTML, CSS, JavaScript, Bootstrap, PHP, node', 30, 'Hostel D, NIT Jamshedpur, Jharkhand', '1', 'B.Tech', 'IT,  Engineering'),
...
--
ALTER TABLE `company`
  MODIFY `company_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `job`
  MODIFY `job_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
